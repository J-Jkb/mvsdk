...
*/
	...
	G_COOL_API_PLAYERUSERCMD_ADD = 1101,
	G_COOL_API_PLAYERUSERCMD_REMOVE = 1102,
	G_COOL_API_PLAYERUSERCMD_CLEAR = 1103,
	G_COOL_API_PLAYERUSERCMD_GET = 1104,
	...
	G_COOL_API_CUSTOMEPSILONTRACE = 1109,
	G_COOL_API_CUSTOMEPSILONTRACE_CAPSULE = 1110,
	G_COOL_API_CROSS_SERVER_COMMAND = 1111,
	G_COOL_API_BENCHMARK = 1112,
	G_COOL_API_POINTCONTENTSHULLFAST = 1113,

	G_COOL_API_DB_ESCAPESTRING = 1200,
	G_COOL_API_DB_ADDREQUEST = 1201,
	G_COOL_API_DB_NEXTRESPONSE = 1202,
	G_COOL_API_DB_GETREFERENCE = 1203,
	G_COOL_API_DB_NEXTROW = 1204,
	G_COOL_API_DB_GETINT = 1205,
	G_COOL_API_DB_GETFLOAT = 1206,
	G_COOL_API_DB_GETSTRING = 1207,
	G_COOL_API_DB_ADDREQUEST_TYPED = 1208,

	G_COOL_API_DB_ADDPREPAREDSTATEMENT = 1209,
	G_COOL_API_DB_PREPAREDBINDSTRING = 1210,
	G_COOL_API_DB_PREPAREDBINDFLOAT = 1211,
	G_COOL_API_DB_PREPAREDBINDINT = 1212,
	G_COOL_API_DB_PREPAREDBINDBINARY = 1213,
	G_COOL_API_DB_FINISHANDSENDPREPAREDSTATEMENT = 1214,
	G_COOL_API_DB_GETBINARY = 1215,
	G_COOL_API_DB_PREPAREDBINDNULL = 1216,
	G_COOL_API_DB_GETMORERESULTS = 1217,

	// COOL_APIFEATURE_JEDI_ACADEMY
	G_COOL_API_GET_NUM_LANGUAGES             = 2000,
	G_COOL_API_GET_LANGUAGE_NAME             = 2001,
	G_COOL_API_GIVE_ME_VECTOR_FROM_MATRIX    = 2002,
	G_COOL_API_SET_SKIN                      = 2003,
	G_COOL_API_SKINLESS_MODEL                = 2004,
